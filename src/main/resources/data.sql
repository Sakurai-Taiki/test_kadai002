...
INSERT IGNORE INTO users (id, user_name, furigana, mail_address, user_password, user_post_code, user_address, user_phone_number, roles_id, enabled) VALUES (2, '櫻井　らら','サクライ　ララ', 'lala.samurai@example.com', '$2a$10$2JNjTwZBwo7fprL2X4sv.OEKqxnVtsVQvuXDkI8xVGix.U3W5B7CO', '123-4567', '長野県三条市本原11-6', '090-1234-5678', 1, 1);
...
--reserveテーブル
INSERT INTO reserve (user_id, store_id, reserve_date, reserve_time, reserve_count) VALUES (1, 1, '2024-11-20', '11:00:00', 5);
INSERT INTO reserve (user_id, store_id, reserve_date, reserve_time, reserve_count) VALUES (2, 1, '2024-11-20', '17:00:00', 4);
